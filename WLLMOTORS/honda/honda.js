...
function atualizarValor() {
    ...
    if (moto === "biz") valorInput.value = 14723;
    else if (moto === "cg150") valorInput.value = 9183;
...
function calcular() {
      ...
      switch (metodo) {
        ...
        case "debito":
          ...
          break;
        case "consorcio":
            mensagem = `Consórcio da Honda disponivel por pagamento ao Mês de no mínimo R$ 225,00.`;
          break;
        case "pix":
          total = valor * 0.88; 
          mensagem = `Pagamento via Pix à vista com 12% de desconto: R$ ${total.toFixed(2)}.`;
          break;
        default:
